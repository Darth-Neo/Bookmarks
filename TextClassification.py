...
class Document(object):
    """ Used both for learning (training) documents and for testing documents. The optional parameter learn
    ...
    def read_document(self, filename, learn=False):
        ...
        text = text.lower()
        words = re.split("[^\wĆ¤Ć¶Ć¼Ć„Ć–ĆĆ]*", text)
...
if __name__ == u"__main__":
    ...
    DClasses = loadList(fileFolders)
    documents = loadList(fileBookmarks)
